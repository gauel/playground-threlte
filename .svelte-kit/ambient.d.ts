...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__theatre_core: string;
	export const npm_package_dependencies__theatre_studio: string;
	export const npm_package_dependencies__threlte_core: string;
	export const npm_package_dependencies__threlte_extras: string;
	export const npm_package_dependencies__threlte_theatre: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__theatre_core: string;
		npm_package_dependencies__theatre_studio: string;
		npm_package_dependencies__threlte_core: string;
		npm_package_dependencies__threlte_extras: string;
		npm_package_dependencies__threlte_theatre: string;
